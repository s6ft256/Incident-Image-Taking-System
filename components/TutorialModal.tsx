...
const steps = [
  ...
  },
  {
    ...
    description: "Head to your Profile to enable Biometric Lock (FaceID/Fingerprint) for rapid authentication. You can also switch between Dark and Light interface protocols.",
    icon: (
