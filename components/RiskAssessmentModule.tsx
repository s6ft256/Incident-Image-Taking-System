...
const BG_IMAGE = 'https://images.unsplash.com/photo-1541888946425-d81bb19480c5?auto=format&fit=crop&q=80&w=2000';
...
export const RiskAssessmentModule: React.FC<RiskAssessmentModuleProps> = ({ appTheme, onBack }) => {
  ...
  return (
    <div className="animate-in slide-in-from-right duration-500 pb-20 max-w-6xl mx-auto relative">
