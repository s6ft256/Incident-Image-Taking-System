...
export const AuditLogViewer: React.FC<AuditLogViewerProps> = ({ appTheme, onBack }) => {
  ...
  if (isCreating) {
    return (
      <div className="animate-in slide-in-from-right duration-500 pb-32 max-w-5xl mx-auto">
        ...
        <form onSubmit={handleCreateSubmit} className={`p-8 sm:p-12 rounded-[3rem] border shadow-2xl relative overflow-hidden ${
  ...
  if (!selectedAuditId) {
    return (
      <div className="animate-in slide-in-from-right duration-500 pb-20 max-w-5xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center">
        ...
        <div className={`rounded-[2.5rem] border overflow-hidden shadow-2xl ${isLight ? 'bg-white border-slate-200' : 'bg-[#0f172a] border-white/10'}`}>
  ...
  return (
    <div className="animate-in slide-in-from-right duration-500 pb-32 max-w-5xl mx-auto">
      ...
      <div className={`p-8 sm:p-12 rounded-[3rem] border shadow-2xl relative overflow-hidden ${
        isLight ? 'bg-white border-slate-200' : 'bg-white/[0.02] border-white/10'
      }`}>
