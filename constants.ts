...
// Helper to safely access env variables avoiding "Property 'env' does not exist on type 'ImportMeta'" error
const env = (import.meta as any).env || {};

// REPLACE THESE WITH YOUR REAL AIRTABLE CREDENTIALS TO TEST
// Prioritize environment variables for security in GitHub/Deployment
...
export const SUPABASE_CONFIG = {
  ...
  BUCKET_NAME: env.VITE_SUPABASE_BUCKET || 'incident-images' // Ensure this bucket exists and is Public
};
