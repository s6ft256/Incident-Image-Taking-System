...
const handleAirtableError = (response: Response, errorData: any): string => {
  ...
  if (response.status === 422) {
    ...
    return `DATABASE MISMATCH: System Error: "${detail}". ACTION: A field in your report does not match the database schema. Contact an administrator to verify the Airtable base configuration.`;
  }
